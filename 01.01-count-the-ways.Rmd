...
The location and scale parameters $\mu$ and $\sigma$ (e.g., mean and standard deviation) we often calculate, and have so since middle school, are not the mean and standard deviation of data $x$. They are not properties of the physical representation of events called **observed data**. These measures use counts of events, measures of, perhaps physical properties like heat, size, time, but in the end they are abstractions and summarizations about the events.
...
## Exercising our grip on reality
